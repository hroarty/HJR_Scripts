...
dtime=datenum(2016,10,2,0,0,2):1/24:datenum(2016,10,4,0,0,0);
...
%wp1=[40.5 -70];
%wp1=[39.5 -73];
% wp=[40+32/60 -70-42/60];
wp1=[40+30/60 -70-00/60];
%wp=[41+10/60 -70-32/60];
%wp1=[35.25 -75];
...
% conf.HourPlot.axisLims=[-70-46/60 -70-32/60 40+26/60 40+36/60];
%conf.HourPlot.axisLims=[-70-36/60 -70-21/60 41+4/60 41+14/60];
...
% conf.Plot.BaseDir='/Users/hroarty/COOL/01_CODAR/MARACOOS/20160410_CG_Drifter_Experiment/20160512_Virtual_HFR_Plots_43104/';
%conf.Plot.BaseDir='/Users/hroarty/COOL/01_CODAR/MARACOOS/20160410_CG_Drifter_Experiment/20160512_Virtual_HFR_plots_43241/';
conf.Plot.BaseDir='/Users/hroarty/COOL/01_CODAR/MARACOOS_II/20160930_QC_Check/20161004_NewEngland_Totals/';
