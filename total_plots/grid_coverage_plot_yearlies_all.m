...
years.num=2007:2016;
year.str=years.num';
year.str=num2str(year.str);
year.str=cellstr(year.str);

cmap = distinguishable_colors(numel(years.num));
...
plot(div,flipud(cumsum(spc)),'LineWidth',2,'color',cmap(ii,:))
...
legend(year.str,'Location','SouthWest')
