...
t2 = [year.str(1:4) '-4-1 00:00:00'];% single year
...
regions={'01_North','02_Central','03_Central','04_South','05_South'};
...
conf.Plot.script='plotRadialVecsFromDB_05.m';
