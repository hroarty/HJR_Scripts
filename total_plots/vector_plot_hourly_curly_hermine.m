...
%% specific period
start_time = datenum(2016,9,3,0,0,2);
end_time=datenum(2016,9,6,23,0,2);
...
% conf.OI.BaseDir='/home/codaradm/data/totals/maracoos/oi/mat/5MHz/ideal/';
...
conf.OI.cleanTotalsVarargin={{'OIuncert','Uerr',0.9},{'OIuncert','Verr',0.9}};
...
conf.HourPlot.print_path='/Users/hroarty/COOL/01_CODAR/MARACOOS_II/20160906_Hermine_Prep/';
...
dir2='/Users/hroarty/COOL/01_CODAR/MARACOOS_II/20160906_Hermine_Prep/20160915_Best_Track_from_Mike_Smith/';
file2='al092016.csv';

[D]=read_in_hurricane_track_hermine2(dir2,file2);
...
hermine.lat_interp = interp1(D{13},D{1},dtime);
hermine.lon_interp = interp1(D{13},D{2},dtime);
hermine.time_interp=dtime;
...
switch conf.region_select
    ...
    lims=[-76 -72 37 39];% MD
    case 'region05'
    lims=[-76 -73 35 38];% VA NC
    case 'Special'
    lims=[-76 -72 37 41];% VA NC
end
...
toc
 ...
 curly_vector_plot_for_NC_fn_hermine(TUV,conf,hermine,ii);
