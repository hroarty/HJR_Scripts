...
%                 2016 6 1 0 0 0;2016 12 1 0 0 0];

time_matrix=[   2017 6 1 0 0 0;2017 6 1 1 0 0];
...
[n,xout]=hist(finalGrid(:,8),100);
 ...
 for kk=1:length(tpc)
     spc(kk)=tpc(kk)*100/length(finalGrid);
     spc=spc';
 end
...
output_filename = ['MARACOOS_Coverage_' datestr(start_time,'yyyymmdd') '_' datestr(end_time,'yyyymmdd') '.png'];
...
clearvars -except time_matrix r c 
close all
