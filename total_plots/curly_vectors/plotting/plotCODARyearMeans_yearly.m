...
fileDir = '/Users/michaesm/Desktop/codar_means/yearly_means/'; %Location of files
...
%     yearStr = file(9:12);
    ...
    fileStr = {['MARACOOS Surface Currents']; ['Time Period: ' timePeriod]};
...
%     set(gcf, 'paperorientation', 'landscape');
    print('-dpng', [dirListing timePeriod '-uvstd-compositeSurfaceCurrents.png'], '-r200')
