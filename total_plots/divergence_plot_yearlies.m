...
% box on
 ...
 title({'MARACOOS HF Radar Divergence Map from';datestr(dtime+datenum(2001,01,01),'yyyy') },'FontWeight','bold','FontSize',14)
% xlabel({''; 'Temporal Coverage (%)'},'FontSize',12)
% ylabel({'Spatial Coverage (%)'; ''},'FontSize',12)


timestamp(1,'/HJR_Scripts/total_plots/divergence_plot_yearlies.m')
