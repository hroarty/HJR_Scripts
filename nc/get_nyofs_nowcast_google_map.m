...
% http://opendap.co-ops.nos.noaa.gov/thredds/dodsC/NOAA/NYOFS/MODELS/201807/nos.nyofs.fields.nowcast.20180715.t00z.nc

conf.file.prefix='http://opendap.co-ops.nos.noaa.gov/thredds/dodsC/NOAA/NYOFS/MODELS/';
conf.file.prefix2='/nos.nyofs.fields.nowcast.';
conf.file.suffix='.nc';

dtime2=datenum(2018,7,15,1,0,0):1/24:datenum(2018,7,15,12,0,0);
...
file=[conf.file.prefix datestr(dtime2(ii),'yyyymm') conf.file.prefix2 datestr(dtime2(ii),'yyyymmdd.tHHz') conf.file.suffix];
...
conf.HourPlot.Mask='/Users/roarty/data/mask_files/25MHz_Mask.txt';
conf.HourPlot.bathylines=[ -10  -20 -50];
conf.HourPlot.CoastFile='/Users/roarty/data/coast_files/MARA_coast.mat';
conf.HourPlot.Bathy='/Users/roarty/data/bathymetry/marcoos_15second_ngdc.mat';
...
title(['NYOFS Water Level ' datestr(dtime2(ii),'mmmm dd, yyyy HH:MM UTC')])
 ...
 conf.Plot.script='get_nyofs_nowcast_google_map.m';
 conf.Plot.print_path ='/Users/roarty/data/NYOFS/TWL/';
