...
dtimes = datenum(2015,1,17,0,0,0):3/24:datenum(2015,1,18,0,0,0);
%saveDir = '/Users/hroarty/COOL/01_CODAR/MARACOOS/20140116_Montauk_SAR_Case/20150410_HYCOM_Plots/';
saveDir = '/Users/hroarty/COOL/STUDENT_ITEMS/Joe_Gradone_2015/20150715_HYCOM/';
...
for w = 1:length(dtimes)
    ...
    streakarrow(X,Y, u, v, 1.75, 1, 2);
    hold on

     xlim([ -74-20/60 -73-40/60]);
     ylim([40+20/60 40+40/60]);
...
%     sl = plot(lon, lat, 'k.', 'markersize', 1);
    ...
    %    
    title({'NAVOCEANO HYCOM Surface Currents'; datestr(curTime, 31)})
    %     
    grid on
