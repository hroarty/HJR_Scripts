...
t1 = [year.str{1} '-1-1 00:00:00'];
t2 = [year.str{end} '-12-31 00:00:00'];
...
conf.Plot.print_path = '/Users/roarty/COOL/01_CODAR/02_Collaborations/Puerto_Rico/20180524_Progress_Report/';
