...
conf.HourPlot.print_path='/Users/hroarty/COOL/01_CODAR/MARACOOS/20131211_MAB_currents/20170426_Decadal_Figures/20171212_Seasonal_Histogram/';
conf.HourPlot.script='histogram_plot_yearlies.m';
...
% conf.HourPlot.TitleString=['Histogram of Surface Currents for Calendar Year ' num2str(years.num(ii)) ' (6km Grid)'];
conf.HourPlot.TitleFontSize=12;

speed = cart2magn( TUV.U, TUV.V );

histogram(speed(:),50)

xlabel('Total Current Velocity (cm/s)')
...
hdls.title = title( conf.HourPlot.TitleString, 'fontsize', conf.HourPlot.TitleFontSize,'color','k');
...
conf.Plot.script='histogram_plot_yearlies.m';
conf.Plot.print_path = '/Users/hroarty/COOL/01_CODAR/MARACOOS/20131211_MAB_currents/20170426_Decadal_Figures/20171212_Seasonal_Histogram/';
conf.Plot.Filename = ['Histogram_' years.seasons{ii} '.png'];
